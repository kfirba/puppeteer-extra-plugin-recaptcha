...
const getBrowser = async (url = '', opts = {}) => {
    ...
    const recaptchaPlugin = index_1.default(opts);
...
ava_1.default('will correctly detect v2-checkbox-auto.html', async (t) => {
...
ava_1.default('will correctly detect v2-checkbox-auto-nowww.html', async (t) => {
...
ava_1.default('will correctly detect v2-checkbox-auto-recaptchadotnet.html', async (t) => {
...
ava_1.default('will correctly detect enterprise-checkbox-auto.html', async (t) => {
...
ava_1.default('will correctly detect enterprise-checkbox-auto-recaptchadotnet.html', async (t) => {
...
ava_1.default('will correctly detect enterprise-checkbox-explicit.html', async (t) => {
...
ava_1.default('will correctly detect v2-invisible-explicit-isolated.html', async (t) => {
...
ava_1.default('will correctly detect v2-invisible-auto.html - active challenge', async (t) => {
...
ava_1.default('will correctly detect v3-programmatic.html with solveScoreBased:false and filter captcha', async (t) => {
...
ava_1.default('will correctly detect v3-programmatic.html with solveScoreBased:true', async (t) => {
    const url = 'https://berstend.github.io/static/recaptcha/v3-programmatic.html';
    const { browser, page } = await getBrowser(url, {
