...
ava_1.default('will solve reCAPTCHA enterprise', async (t) => {
    if (!process.env.TWOCAPTCHA_TOKEN) {
        t.truthy('foo');
        console.log('TWOCAPTCHA_TOKEN not set, skipping test.');
        return;
...
ava_1.default('will solve multiple reCAPTCHAs', async (t) => {
    if (!process.env.TWOCAPTCHA_TOKEN) {
        t.truthy('foo');
        console.log('TWOCAPTCHA_TOKEN not set, skipping test.');
        return;
...
ava_1.default('will not solve inactive invisible reCAPTCHAs by default', async (t) => {
    if (!process.env.TWOCAPTCHA_TOKEN) {
        t.truthy('foo');
        console.log('TWOCAPTCHA_TOKEN not set, skipping test.');
        return;
...
ava_1.default('will not solve score based reCAPTCHAs by default', async (t) => {
    if (!process.env.TWOCAPTCHA_TOKEN) {
        t.truthy('foo');
        console.log('TWOCAPTCHA_TOKEN not set, skipping test.');
        return;
